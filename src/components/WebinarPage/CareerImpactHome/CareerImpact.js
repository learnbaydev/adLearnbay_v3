        ...
        >
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/preksha-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/asrar-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/aravind-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/ritesh-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/saurabh-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/abhishek-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
          ...
          <SwiperSlide className={styles.slide}>
            <div className={styles.content}>
              <div className={styles.imgP}>
                <Image
                  src="https://d32and0ii3b8oy.cloudfront.net/main/vishal-home.png"
                  layout="intrinsic"
                  width="100"
                  height="100"
                  alt="akanksha-home"
