          ...
          <div className={styles.minContainer}>
            <div className={styles.firstMin}>
              <p className={styles.para}>
                <span><b>Address</b>: </span>1090 1st floor, 18th Cross Rd, above
                Sangam Sweets, Sector 3, HSR Layout, Bengaluru, Karnataka 560102
              </p>
              <hr />
            ...
            <a href="https://maps.app.goo.gl/8YmZ7BscDKvDYHBA7" target="_blank"><div className={styles.image}>
            <Image
