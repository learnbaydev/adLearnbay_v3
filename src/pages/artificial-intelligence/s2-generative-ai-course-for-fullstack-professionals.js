  ...
  return (
    <>
      ...
      <main>
        ...
        <PSummaryAD
          summaryData={
            DataScienceCourseData.GenAiDevlopersData[0].summarySection
          }
        />
        ...
        <AnimationGEN
          whyChooseData={
            DataScienceCourseData.GenAiDevlopersData[0].whyChooseData
          }
        />
        ...
        <LJourney />
        <NewTools
          toolsData={DataScienceCourseData.GenAiDevlopersData[0].toolsData}
        />
        ...
        />
        <Certificate
          data={DataScienceCourseData.GenAiDevlopersData[0].Certificate}
          noTabs={true}
        />
        ...
        <DSAFeeSection
          ...
          monthlyPayment1="₹7,605"
          greenDown1="Standard Intrest rate Applicable"
          duration2="12 Months"
          totalAmount2="₹1,25,000"
          monthlyPayment2="₹ 10,417"
        />

        <SliderTabs WithoutService={true} />
        <GenAIProject
          genAiData={DataScienceCourseData.GenAiDevlopersData[0].genAiData}
          Duration={true}
        />
        <SeventhSection />
