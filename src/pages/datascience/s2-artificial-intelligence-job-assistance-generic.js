...
function Blockchain({ AIMLDataScienceCourseDataJson }) {
  ...
  return (
    <>
      <Head>
        <title>
          Learn Online Artificial Intelligence job assistance Generic - Learnbay
        </title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.learnbay.co/datascience/s2-artificial-intelligence-job-assistance-generic"
        />
      </Head>
      <main>
        ...
        <FirstSection
          ...
          firstHeading="Artificial Intelligence Job Assistance Course "
