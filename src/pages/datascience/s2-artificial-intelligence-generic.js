...
function Blockchain({ AIMLDataScienceCourseDataJson }) {
  ...
  return (
    <>
      <Head>
        <title>
          Master AI with Learnbay's Advanced Certification Program - Learnbay
        </title>
        <meta
          name="description"
          content="Unlock the future with Learnbay's Advanced AI Certification Program. Gain expertise in artificial intelligence through our comprehensive and hands-on training. Elevate your career today!"
        />
        <meta name="robots" content="index, follow" />
        <meta
          name="keywords"
          content="ai course, artificial intelligence course, ai courses, artificial intelligence online course, ai course, artificial intelligence course, ai certificate course, ai courses online, best ai courses"
        />
        <link
          rel="icon"
        ...
        <link
          rel="canonical"
          href="https://course.learnbay.co/datascience/s2-artificial-intelligence-generic"
        />
      </Head>
      <main>
        ...
        <FirstSection
          ...
          firstHeading="Artificial Intelligence Course"
