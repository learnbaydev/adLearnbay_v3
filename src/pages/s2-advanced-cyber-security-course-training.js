...
function Blockchain({ DataScienceCourseDataJson, whyChooseData }) {
  ...
  return (
    <>
      <Head>
        <title>
          Best Cyber Security & Ethical Hacking Course | EC-Council 
        </title>
        <meta
          name="description"
...
/> */}
      ...
      <main>
        ...
        <PSummaryAD
          summaryData={
            DataScienceCourseData.ECMicroCyberSecurityData[0].summarySection
          }
        />
        ...
        ecMicro={true}
          whyChooseData={
            DataScienceCourseData.ECMicroCyberSecurityData[0].whyChooseData
          }
          cyber={true}
        />
        ...
        <LJourney />
        <NewTools
          toolsData={DataScienceCourseData.ECMicroCyberSecurityData[0].toolsData}
        />
        <SyllabusNew
          buttonHide={true}
          interstedInHide={true}
          ...
          masterSyllabusMobile={
            DataScienceCourseData.ECMicroCyberSecurityData[0].masterSyllabusMobile
          }
          onebtn={true}
        />
        <Certificate
      ecMicro={true}
data={DataScienceCourseData.ECMicroCyberSecurityData[0].Certificate}
   
        />
        {/* <NewCertificateSection
          certificateNew={
            DataScienceCourseData.ECMicroCyberSecurityData[0].certificateNew
          }
        /> */}
...
export async function getStaticProps() {
  const data = await import("../Data/ECMicroCyberSecurityData");
